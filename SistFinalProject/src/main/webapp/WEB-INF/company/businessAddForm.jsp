...
<body>
<h3><a href="/"	class="t" style="font-family: 'Jalnan'; text-align: center; margin-top: 20px; color: #f7323f; cursor:pointer; text-decoration: none; outline: none;">TRIVIEW</a></h3>
<br>
				...
				<td>
					<div class="cs"  style="margin: auto;">
						<div class="content" style="width:480px;" align="left">
							사업자등록번호<br> 
							<span class="i">
								<input type="text" name="business_id" id="bNum" class="form-control" required="required" style="width: 330px;" placeholder="사업자등록번호를 입력해주세요">&nbsp;&nbsp;&nbsp;
								<button type="button" class="btn" id="bNumChk"	style="background-color: #f7323f; color: white; width:30%; font-family: 'Jalnan';">중복체크</button>
							</span>
							<br>
							<span class="bNumOk" style="color: green; font-size: 12px;"></span><br>
							 비밀번호<br> 
								<input type="password" name="business_pass"	id="pass1" class="form-control" required="required"	style="width: 300px;" placeholder="비밀번호를 입력해주세요">
								<span class="passvalid" style="font-size: 12px;"></span>
								&nbsp;&nbsp;<br>
							비밀번호 확인<br>
								<div style="display: flex;">
									<input type="password" name="pass2" id="pass2" class="form-control" required="required" style="width: 300px;" placeholder="비밀번호를 다시 입력해주세요">&nbsp;&nbsp;<br> 
									<span class="passok" style="font-size: 12px;"></span>
								</div><br>
							 상호명<br> 
								<span class="accommodation"> 
									<input	type="text" name="business_company" id="accom" class="form-control"	required="required" style="width: 300px;" placeholder="상호명을 입력해주세요">&nbsp;&nbsp;&nbsp;		
								</span>
								<br>
							 대표자<br> 
								 <input type="text" name="business_name"	class="form-control" required="required" style="width: 300px;" placeholder="대표자명을 입력해주세요"><br> 
							 휴대폰<br> 
