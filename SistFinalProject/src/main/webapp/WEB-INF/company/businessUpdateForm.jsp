				...
				<td>
					<div class="content">
						...
						<span class="accommodation"> 
							<input	type="text" value="${businessDto.business_company}" name="business_company" id="accom" class="form-control"	required="required" style="width: 300px;" placeholder="상호명을 입력해주세요">&nbsp;&nbsp;&nbsp;
						</span>
						<br>
						 비밀번호<br> 
						<input type="password" name="business_pass" value="${businessDto.business_pass }"	id="pass1" class="form-control" required="required" style="width: 300px;" placeholder="비밀번호를 입력해주세요">&nbsp;&nbsp;
						<br>
						비밀번호 확인<br>
