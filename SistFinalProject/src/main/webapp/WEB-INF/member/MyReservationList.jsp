...
<br>
	<div style="display: flex; flex-wrap: wrap; width: 100%;justify-content: space-between;">
		<c:forEach items="${list }" var="reserveDto" varStatus="i">
			...
			<div>
				<table class="table table-bordered" style="width: 55vh; margin: 3vh 3vh; float: left;">
					<tr>
					...
					<tr>
						<td align="right" valign="middle" colspan="2">
							<button type="button" class="room_detail_reserve_btn" id="reserve-cancle"	value="${reserveDto.reserve_id}">예약취소</button>
						</td>
					</tr>
				</c:if>
			</table>
