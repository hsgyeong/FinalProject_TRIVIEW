...
<table class="tb">
	<tr>
		<td>
			<img alt="" src="../loginsave/s7.png" class="img" width="150px;" height="150px;"> 
		</td>
	</tr>
	<tr>
		<td>
			<hr>
			<button type="button" class="btn coupon" style="background-color: #f7323f; color:white;font-weight: bold;" onclick="location.href='/member/mycoupon'">
				<i class="bi bi-c-circle"></i>&nbsp;쿠폰함<br>${memberDto.info_coupon }&nbsp;개<br>
			</button>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<button type="button" class="btn point" style="background-color: #f7323f; color:white; font-weight: bold;" onclick="location.href='/member/mypoint'">
				<i class="bi bi-database-add"></i>&nbsp; 포인트<br>${memberDto.info_point }&nbsp;원
			</button>
		<br>
		<hr>
		</td>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
      	 <button type="button" class="btn del" id="btndelete" style="background-color: white;" onclick="location.href=/member/delete-member">회원탈퇴</button>
