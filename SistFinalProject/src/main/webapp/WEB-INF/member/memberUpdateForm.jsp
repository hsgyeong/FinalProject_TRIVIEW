...
<body>
	<form action="update-member" method="post" id="updateForm">
					...
					<td>
						<div class="cs"  style="margin: auto;">
							<div class="content" style="width:480px;" align="left">		
								...
								<br><br>	
								비밀번호<br>
								<input type="password" name="info_pass" value="${memberDto.info_pass }"	id="pass1" class="form-control" required="required"	style="width: 300px;" placeholder="비밀번호를 입력해주세요">
								...
								<br> 
								<span class="nickch"> 
									<input	type="text" name="info_nickname" value="${memberDto.info_nickname }" id="nick" class="form-control"	required="required" style="width: 330px;" placeholder="닉네임을 입력해주세요">&nbsp;&nbsp;&nbsp;
								...
								<span style="font-size: 12px; color: gray;">(선택사항)</span> 
								<br> 
		...
		<div class="bt" style="text-align: center;">
			<button type="submit" class="btn" style="background-color: #f7323f; color: white; width: 200px; font-family: 'Jalnan';">회원정보 수정</button>
		</div>
	</form>
</body>
</html>