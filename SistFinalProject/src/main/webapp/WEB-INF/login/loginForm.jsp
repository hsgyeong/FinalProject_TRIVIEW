...
.businessPass, .memberPass{
	position:relative;
	display: flex;

}

.businessShowPass, .memberShowPass {
	position: absolute;
	left:253px;
	top:5px;
	cursor:pointer;
		...
		<table class="table .table-borderless tb" style="width: 300px;">
			<tr>
				<td>
					<div class="logtitle">
						<h2>
							<a href="/"	style="font-family: 'Jalnan'; text-align: center; margin-top: 20px; color: #f7323f; cursor: pointer; text-decoration: none; outline: none;">TRIVIEW</a>
						</h2>
					</div> 
				<br>
				<br>
				...
				<td>
					...
					<div class="memberLogin">
						<form action="/login/member-login" method="post">
							<span class="id">아이디 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
								<input type="text" name="info_id" style="width: 200px;" class="form-control" required="required" value="${sessionScope.saveok==null?'':sessionScope.info_id }">
							</span>
							<br>
							<br>
							<span class="member input-group">	
								<div class="memberPass">비밀번호 &nbsp;&nbsp;&nbsp;
									<input type="password" name="info_pass" style="width: 200px;" class="form-control" required="required" id="member_pass">&nbsp;&nbsp;
					...
					<div class="businessLogin">
						<form action="/login/business-login" method="post" >
							<span class="businessId">사업자번호 &nbsp;&nbsp; 
								<input type="text" name="business_id" id="bNum" required="required" style="width: 190px;" class="form-control"
								 value="${sessionScope.saveok==null?'':sessionScope.business_id }">		
							</span>	
							 <br> 
							<span class="business input-group">
								<div class="businessPass">비밀번호&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
									<input type="password" name="business_pass" required="required"	style="width: 190px;" class="form-control" id="business_pass">&nbsp;&nbsp;
							...
							<br>
							<br>
							<button type="submit" class="btn loginbt">&nbsp;&nbsp;로그인</button>
							<br>
					   </form>
					</div>
				</td>
